...
public class JsonToFile {
    ...
    public static void main(String[] args) {
        ...
        try {
            Object obj = parser.parse(new FileReader("D:\\code2\\JsonToFile\\src\\main\\resources\\strong-positives.json"));
...
//                System.out.println(i);
                if(i > 30523){
                    if (newStr != "" && newStrSize > 5) {
                        File file = new File("D:\\code2\\JsonToFile\\src\\main\\resources\\tweets-labeled\\positive\\" + i + ".txt");
                        file.createNewFile();
